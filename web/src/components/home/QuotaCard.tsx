  ...
  return (
    <section className="rounded-3xl bg-white p-5 shadow-sm">
      <div className="flex items-center justify-between">
        <span className="text-sm text-warm-gray">Tu tarifa actual</span>
      ...
      <p className="text-sm text-warm-gray">
        disponibles de {formatMinutesAsHours(quota.totalMinutes)}
      </p>
      ...
      <p className="mt-2 text-sm text-warm-gray">
        {formatMinutesAsHours(quota.usedMinutes)} utilizadas este mes
      </p>
    </section>
  );
}
